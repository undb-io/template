<footer class="bg-white dark:bg-gray-800">
  <div class="mx-auto w-full max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
    ...
    <ul class="mt-3 flex flex-wrap items-center gap-2 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
      ...
      <li>
        <a href="https://github.com/undb-io/undb" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
          <svg
            class="h-4 w-4"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <a href="mailto:hi@undb.io" class="hover:underline">Contact</a>
      </li>
    </ul>
  </div>
</footer>
